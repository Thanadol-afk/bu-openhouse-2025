...
const ProfileCard: React.FC = () => {
    ...
    const socialLinks = [
        {
            name: 'Email',
            href: 'mailto:thanadolvongsakhote@gmail.com',
            icon: (
        ...
        {
            name: 'Facebook',
            href: 'https://facebook.com/Thanadol Vongsakhote',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <p className="text-white font-medium text-sm sm:text-base">thanadolvongsakhote@gmail.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <p className="text-white font-medium text-sm sm:text-base">+66 0629833248</p>
                                </div>
                            </div>
                        </div>
                    </div>
